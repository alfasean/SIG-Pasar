...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_FILES['foto']['name'])) {
        ...
        if ($foto !== null) {
            $sql = "UPDATE bahan_pokok SET nama_bahan='$nama_bahan', harga='$harga', gambar='$foto', id_pasar='$id_pasar' WHERE id_bahan_pokok=$id_bahan_pokok";
        } else {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        echo '<script>window.location.href = "admin.php?page=bahan_pokok";</script>';
        exit();
    } else {
        ...
        <div class="form-container mt-5">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <img src="uploads/bahan_pokok/<?php echo $row['gambar']; ?>" alt="Foto" width="100">
