...
if (isset($_SESSION['session_username'])) {
    header("location:admin_pasar_page.php");
    exit();
}

if (isset($_POST['tb_admin_pasar'])) {
    ...
    if ($username == '' or $password == '') {
        ...
        $sql1 = "SELECT * FROM tb_admin_pasar WHERE username = '$username'";
        ...
        if (empty($err)) {
            ...
            // Simpan id_pasar ke dalam sesi
            $_SESSION['id_pasar_login'] = $r1['id_pasar'];
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <h2 class="text-center mb-4">Login Admin Pasar</h2>
                        <?php echo $err; ?>
                        <form method="POST">
                            <div class="mb-3">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary" name="tb_admin_pasar">Login</button>
                            </div>
                        </form>
                    </div>
                </div>
